  ...
  return (
    <ScrollView >
      ...
      <View style={{
        ...
        >
          <Text style={{ color: "#0178BE" ,fontWeight:'bold',fontSize:20 }}>wk51</Text>
        </View>
        <View
          style={{
      ...
      <Text style={{color:'#0178BE',fontSize:12,marginTop:20,marginBottom:20}}>Top 100</Text>
      <View style={{...styles.play,borderColor:'#05B852', borderWidth:2,}}>
